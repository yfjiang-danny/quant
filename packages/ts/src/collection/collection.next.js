...
exports.dailyCollection = void 0;
...
function log(msg) {
    logs_1.logger.info(msg, path_1.default.resolve(paths_1.logRootPath, "collection.db.log"));
}
function stockInfo() {
    return __awaiter(this, void 0, void 0, function () {
        var allBasicStocks, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, api_1.TUSHARE_API.getAllStock()];
                case 1:
                ...
                case 2:
                    res = _a.sent();
                    if (!res.data) {
                        log("Update stock info failed: ".concat(res.msg));
                    }
                    else {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!allBasicStocks.data || allBasicStocks.data.length === 0) {
                        log("Update daily info failed: empty basic stocks, ".concat(allBasicStocks.msg));
                        return [2 /*return*/];
                    }
                ...
                case 2:
                    ...
                    return [4 /*yield*/, storage_1.Storage.insertStockHistories(dailyStocks)];
                case 3:
                    res = _a.sent();
                    if (res.data) {
                        ...
                        log("Update daily info failed: ".concat(res.msg));
                    }
                    return [2 /*return*/];
            }
        });
...
function dailyCollection(mailer) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            queue.process(function (_a, done) {
                var data = _a.data;
            ...
            queue.setLast(function () {
                log("Daily collection complete");
            });
            queue.add(stockInfo);
            queue.add(snapshot);
            queue.add(derivative_1.fillingLadder);
            return [2 /*return*/];
        });
    });
}
exports.dailyCollection = dailyCollection;
